...
public class BattleUnitTornado : BattleUnit
{
    ...
    {
        List<BattleUnit> fireUnits = BattleManager.Instance.CheckCellForUnit(this, UnitType.Fire);
        if (fireUnits!=null)
        {
        ...
        List<BattleUnit> people = BattleManager.Instance.CheckCellForUnit(this, UnitType.People);
        if (people!=null)
        {
